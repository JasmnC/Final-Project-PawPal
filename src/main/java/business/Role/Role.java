...
public abstract class Role {
    ...
    public enum RoleType {
        Admin("Admin"),
        AnimalRegister("Animal Registor"),
        AnimalManager("Animal Manager"),
        Vet("Vet"),
        Pharmacy("Pharmacy"),
        BehaviorTharapist("Behavior Tharapist"),
        AdoptorManager("Adoptor Manager"),
        Adoptor("Adoptor"),
        Volurnteer("Volurnteer"),
        VolurnteerManager("Volurnteer Manager");
